...
export const projects: Project[] = [
  {
    ...
    architecture: "Laravel 12 backend exposing a REST API, MySQL database with role-based access for customers, providers, and admins. Modern JavaScript frontend with Tailwind CSS, live GPS tracking, and real-time notification pipeline.",
    databaseSchema: "Users, Roles, ServiceCategories, Services, Bookings, Payments, Reviews, Notifications, TrackingEvents",
    authFlow: "Multi-role authentication (customer, provider, admin) with role-based middleware authorization and secure session management.",
    apiEndpoints: [
      "GET /api/services — public service listing with category filters",
      "POST /api/bookings — create smart service booking",
      "GET /api/bookings/{id}/tracking — live GPS tracking updates",
      "POST /api/payments — secure online payment processing",
    ],
    adminFeatures: [
      "Provider verification and management",
      "Booking and service oversight",
      "Payment and revenue analytics",
      "Ratings & reviews moderation",
      "Notification broadcasting",
    ],
    securityDetails: "Role-based access control, input validation, secure payment handling, and Laravel's built-in protections (CSRF, XSS escaping, SQL injection prevention via Eloquent).",
    challenges: [
      "Designing a multi-role system (customer, provider, admin) with clean authorization boundaries",
      "Implementing reliable live GPS tracking for in-progress bookings",
      "Building a secure payment flow that keeps users informed at every step",
    ],
    lessons: [
      "Laravel 12's modern primitives make multi-role systems clean and maintainable",
      "Real-time features need a carefully designed notification pipeline",
      "Trust is built through transparency — live tracking and reviews both matter",
    ],
    futureImprovements: ["Mobile application", "AI-powered provider matching", "In-app chat between customers and providers"],
  },
  {
  ...
  },
  {
    slug: "study-master",
    title: "Study Master",
    description: "Study planner with subjects, tasks, calendar, analytics, progress tracking and student dashboard built with Laravel.",
    shortDesc: "Laravel study planner with analytics",
    longDescription: "A comprehensive study planning platform built with Laravel that helps students organize their subjects, manage tasks, track progress through analytics, and stay on schedule with an intuitive calendar and dashboard.",
    category: "Laravel",
    tags: ["Laravel", "PHP", "MySQL", "Dashboard"],
    liveUrl: "#",
    githubUrl: "#",
    problem: "Students struggle to organize multiple subjects, track deadlines, and maintain consistent study habits without a centralized planning tool.",
    solution: "Built a Laravel-powered study planner with subject management, task tracking, calendar integration, progress analytics, and a comprehensive student dashboard.",
    features: [
    ...
    architecture: "Laravel monolith with MySQL database, service-layer for business logic, calendar integration, and analytics engine for progress tracking.",
    databaseSchema: "Users, Subjects, Tasks, StudySessions, ProgressRecords, CalendarEvents",
    authFlow: "Laravel authentication with role-based access for students and admins.",
    adminFeatures: [
      "User management",
    ...
    challenges: [
      "Designing an intuitive calendar system for study scheduling",
      "Building accurate progress analytics from study session data",
    ],
    lessons: [
      "Eloquent relationships simplify complex analytics queries",
      "Service pattern keeps business logic clean and testable",
    ],
  },
  {
