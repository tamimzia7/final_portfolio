...
const PRIMARY = "#FF2D20";
const PRIMARY_LIGHT = "#FF6B35";
const GOLD = "#FF8C42";
const P_RGB = "255,45,32";
const G_RGB = "255,140,66";
...
const VISION = [
  {
    ...
    text: "A complete, modern storefront that makes browsing fashion feel natural and enjoyable.",
  },
  {
    icon: "layout-dashboard",
    title: "Complete Ownership",
    text: "Full control over the store — products, orders, customers and reviews all in one platform.",
  },
  {
    icon: "shield",
    title: "Trust & Convenience",
    text: "Reviews, clear pricing and reliable order tracking build shopper confidence at every step.",
  },
];

const PROBLEMS = [
  { icon: "search", title: "Limited Storefront", text: "Sellers rely on messaging apps and static pages with no real store experience." },
  { icon: "clipboard", title: "Manual Ordering", text: "Orders are captured by hand, leading to errors and slow fulfillment." },
  { icon: "alert", title: "Poor Discovery", text: "No categories, search or filters to help shoppers find what they need." },
  { icon: "star", title: "No Social Proof", text: "Without reviews, shoppers can't judge product or seller quality." },
  { icon: "layers", title: "Scattered Experience", text: "No persistent cart or wishlist — shopping across devices is inconsistent." },
  { icon: "trending-up", title: "Hard to Scale", text: "Manual processes make growing the catalog and order volume painful." },
];

const SOLUTIONS = [
  { icon: "layout-dashboard", title: "Complete Catalog", text: "A rich product catalog with categories and filtering." },
  { icon: "server", title: "Session Cart", text: "A persistent cart that survives refreshes and sessions." },
  { icon: "clipboard", title: "Order Workflow", text: "Clear order processing with status tracking end to end." },
  { icon: "star", title: "Review System", text: "Customer reviews and ratings build real social proof." },
  { icon: "sliders", title: "Admin Dashboard", text: "Products, orders and customers managed from one panel." },
  { icon: "shield", title: "Solid Architecture", text: "Laravel best practices keep the platform fast and reliable." },
];
...
const ROLES = [
  {
    icon: "user",
    title: "Customer",
    text: "Browse the fashion catalog, manage a cart and wishlist, and complete orders with confidence.",
    points: ["Browse & filter catalog", "Cart & wishlist", "Checkout & reviews"],
  },
  {
    icon: "sliders",
    title: "Admin",
    text: "Run the store — products, variants, orders and customers from a full admin dashboard.",
    points: ["Product CRUD", "Order status workflow", "Customer management"],
  },
];

const JOURNEY = [
  { title: "Discover", text: "Land on a modern storefront with featured products." },
  { title: "Browse Catalog", text: "Explore categories and filter by product type." },
  { title: "View Details", text: "Inspect product images, sizes and pricing." },
  { title: "Add to Cart", text: "Build your order with a persistent session cart." },
  { title: "Checkout", text: "Enter details and place the order securely." },
  { title: "Order Confirmed", text: "Receive confirmation with order tracking." },
  { title: "Admin Fulfills", text: "The store processes and ships the order." },
  { title: "Review", text: "Rate the product and share your experience." },
];

const FEATURES = [
  { icon: "user-check", title: "Authentication", text: "Laravel Breeze auth with email verification and reset." },
  { icon: "layout-dashboard", title: "Product Catalog", text: "Category-based catalog with rich product views." },
  { icon: "server", title: "Shopping Cart", text: "Session-persisted cart that survives refreshes." },
  { icon: "star", title: "Wishlist", text: "Save favourite items for a later purchase." },
  { icon: "credit-card", title: "Checkout & Orders", text: "Order processing with a clear status workflow." },
  { icon: "message-circle", title: "Reviews & Ratings", text: "Customer feedback with validation and moderation." },
  { icon: "sliders", title: "Admin Dashboard", text: "Full product CRUD with image upload." },
  { icon: "clipboard", title: "Order Management", text: "Status tracking from placement to delivery." },
  { icon: "user", title: "Customer Management", text: "Customer accounts with complete order history." },
  { icon: "layers", title: "Product Variants", text: "Sizes and colors modeled cleanly in the schema." },
  { icon: "database", title: "Inventory Tracking", text: "Stock levels kept accurate and visible." },
  { icon: "monitor", title: "Responsive UI", text: "Blade views that feel native on every device." },
];

const ARCHITECTURE = [
  { icon: "user", label: "Customer", caption: "Online shoppers" },
  { icon: "monitor", label: "Frontend", caption: "Blade templates + JavaScript" },
  { icon: "server", label: "Laravel Backend", caption: "Laravel + PHP" },
  { icon: "code", label: "Service Layer", caption: "Business logic services" },
  { icon: "database", label: "MySQL", caption: "Eloquent ORM, normalized schema" },
  { icon: "layout-dashboard", label: "Admin Dashboard", caption: "Products, orders & customers" },
];

const STACK = [
  { icon: "monitor", title: "Frontend", items: ["Blade", "JavaScript", "Responsive UI"] },
  { icon: "server", title: "Backend", items: ["Laravel", "PHP", "Breeze Auth"] },
  { icon: "database", title: "Database", items: ["MySQL", "Eloquent ORM", "Product Variants"] },
  { icon: "tool", title: "Tools", items: ["Git & GitHub", "Composer", "Artisan CLI"] },
  { icon: "layers", title: "Architecture", items: ["Service Layer", "Form Requests", "Modular Views"] },
];
...
const GALLERY = [
  {
    src: bp1,
    label: "Homepage",
    alt: "Naw Boutique Homepage",
    description: "Modern storefront homepage with featured products, categories and a seamless shopping flow.",
    badges: ["Hero UI", "Categories", "Featured Products"],
  },
  {
    src: bp2,
    label: "Product Details",
    alt: "Naw Boutique Product Details",
    description: "Detailed product view with images, sizing, pricing and add-to-cart actions.",
    badges: ["Product View", "Variants", "Cart"],
  },
  {
    src: bp3,
    label: "Admin Dashboard",
    alt: "Naw Boutique Admin Dashboard",
    description: "Admin panel for product CRUD, order status, customers and reviews.",
    badges: ["Dashboard", "Orders", "Products"],
  },
];

const HERO_SLIDES = [
  { src: bp1, alt: "Naw Boutique Homepage" },
  { src: bp2, alt: "Naw Boutique Product Details" },
  { src: bp3, alt: "Naw Boutique Admin Dashboard" },
];

const CHALLENGES = [
  {
    topic: "Product Variants",
    challenge: "Handling sizes, colors and stock in a normalized schema.",
    solution: "A variant model linked to products, keeping data clean and queries fast.",
  },
  {
    topic: "Persistent Cart",
    challenge: "Keeping the cart intact across sessions and devices.",
    solution: "Session-backed cart with clean database persistence on checkout.",
  },
  {
    topic: "Review System",
    challenge: "Collecting honest feedback with validation and moderation.",
    solution: "Validated review submissions with admin moderation controls.",
  },
  {
    topic: "Order Workflow",
    challenge: "Tracking orders through a reliable status pipeline.",
    solution: "A clear order status model updated at every stage of fulfillment.",
  },
  {
    topic: "Performance",
    challenge: "Keeping catalog and order queries fast as data grows.",
    solution: "Eager loading, pagination and database indexes throughout.",
  },
  {
    topic: "Admin UX",
    challenge: "Making day-to-day store management effortless.",
    solution: "A dashboard with product CRUD, image upload and status tracking.",
  },
];

const JOURNEY_DEV = [
  { icon: "search", title: "Research", text: "Studied fashion e-commerce patterns and shopper flows." },
  { icon: "list-checks", title: "Planning", text: "Defined catalog, cart, checkout and admin scope." },
  { icon: "pencil", title: "UI Design", text: "Designed a clean, modern storefront with Blade." },
  { icon: "code", title: "Development", text: "Built the Laravel backend and frontend views." },
  { icon: "flask", title: "Testing", text: "Validated auth, cart, checkout and admin flows." },
...
const ROADMAP = [
  ...
  { icon: "database", title: "Advanced Inventory", text: "Bulk stock updates and low-stock alerts." },
  { icon: "sparkles", title: "Discounts & Coupons", text: "Promotions and coupon codes for shoppers." },
  { icon: "smartphone", title: "Mobile App", text: "A native shopping experience on mobile." },
  { icon: "trending-up", title: "Advanced Analytics", text: "Deep sales and customer insights for admins." },
];

const LEARNINGS = [
  { icon: "layers", title: "Blade Components", text: "Componentized Blade views make UI reuse clean and maintainable." },
  { icon: "database", title: "Eloquent Relationships", text: "Eloquent makes complex product variant queries simple." },
  { icon: "clipboard", title: "Form Requests", text: "Centralized validation keeps every form organized." },
  { icon: "server", title: "Cart Architecture", text: "Session carts need careful, deliberate data modeling." },
  { icon: "trending-up", title: "Eager Loading", text: "Query efficiency transforms storefront performance." },
  { icon: "code", title: "E-commerce Domain", text: "Order workflows reward thoughtful design early." },
];

export default function NawBoutiqueCaseStudyPage() {
  ...
  return (
    <PageTransition direction="up">
      {/* ============ SECTION 1 — HERO ============ */}
      <section className="naw-hero relative min-h-[92vh] flex items-center overflow-hidden pt-32 pb-24">
          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
            <ScrollReveal>
              ...
              <p className="text-white/40 text-base md:text-lg max-w-xl leading-relaxed mb-10">
                Naw Boutique is a complete fashion e-commerce platform built with Laravel and Blade —
                authentication, product catalog, cart, wishlist, orders, reviews and a powerful admin dashboard.
              </p>
              ...
              <div className="flex flex-wrap gap-3 mb-10">
                ...
                <Button variant="secondary" as="a" href="https://github.com/tamimzia7/boutique-ecommerce">
              ...
              <div className="flex flex-wrap gap-2">
                {["Cart & Checkout", "Order Tracking", "Reviews", "Admin Dashboard"].map((chip) => (
                  <span
                    key={chip}
              ...
              <div className="relative">
                ...
                <div className="absolute -top-5 -right-4 md:-right-8 animate-float">
                  <div className="flex items-center gap-3 px-4 py-3 rounded-2xl glass" style={{ borderColor: `rgba(${P_RGB},0.25)`, boxShadow: `0 20px 60px -15px rgba(${P_RGB},0.25)` }}>
                    ...
                    <div>
                      <p className="text-xs font-semibold text-white/80">Customer Reviews</p>
                      <p className="text-[10px] text-white/35">Trusted feedback</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="absolute -bottom-5 -left-4 md:-left-8 animate-float" style={{ animationDelay: "1.5s" }}>
                  <div className="flex items-center gap-3 px-4 py-3 rounded-2xl glass" style={{ borderColor: `rgba(${G_RGB},0.25)`, boxShadow: `0 20px 60px -15px rgba(${G_RGB},0.2)` }}>
                    ...
                    <div>
                      <p className="text-xs font-semibold text-white/80">Order Tracking</p>
                      <p className="text-[10px] text-white/35">Clear status flow</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <SectionShell id="vision" tint>
        <SectionHeading
          title="The"
          highlight="Vision"
          subtitle="Why Naw Boutique exists — and what it's building toward."
        />
        <ScrollReveal delay={0.1}>
          <p className="text-white/45 text-lg md:text-xl leading-relaxed max-w-3xl mb-14">
            Naw Boutique was built on a simple belief — <span className="text-white/80 font-semibold">a boutique deserves a real online store, not a chat thread.</span>{" "}
            The platform exists to give fashion sellers the full e-commerce stack — catalog, cart, checkout,
            reviews and admin control — in one clean, reliable Laravel application.
          </p>
        </ScrollReveal>
        <motion.div
          variants={container}
      ...
      <SectionShell id="problem">
        <SectionHeading
          title="Problems"
          highlight="We Solve"
          subtitle="The real pain points behind every struggling fashion storefront."
        />
        <motion.div
          variants={container}
          initial="hidden"
      ...
      <SectionShell id="solution" tint>
        <SectionHeading
          title="Our"
          highlight="Solution"
          subtitle="How Naw Boutique turns every problem into a seamless experience."
        />
        <motion.div
          variants={container}
          initial="hidden"
      ...
      <SectionShell id="roles">
        <SectionHeading
          title="User"
          highlight="Roles"
          subtitle="Two personas, one complete storefront."
        />
        <motion.div
          variants={container}
          initial="hidden"
      ...
      <SectionShell id="journey" tint>
        <SectionHeading
          title="Shopping"
          highlight="Journey"
          subtitle="From discovery to review — every step designed for clarity."
        />
      ...
      <SectionShell id="features">
        <SectionHeading
          title="Key"
          highlight="Features"
          subtitle="A complete toolkit for a modern fashion storefront."
        />
        <motion.div
          variants={container}
          initial="hidden"
      ...
      <SectionShell id="gallery" tint>
        <SectionHeading
          title="Project"
          highlight="Gallery"
          subtitle="Real screenshots of the Naw Boutique experience — click any screenshot to view it fullscreen."
        />
        <motion.div
          variants={container}
          initial="hidden"
      ...
      <SectionShell id="roadmap">
        <SectionHeading
          title="Future"
          highlight="Roadmap"
          subtitle="Where Naw Boutique is heading next."
        />
        <motion.div
          variants={container}
          initial="hidden"
      ...
      <SectionShell id="learnings" tint>
        <SectionHeading
          title="Key"
          highlight="Learnings"
          subtitle="What building a complete e-commerce platform taught me."
        />
        <motion.div
          variants={container}
          initial="hidden"
          ...
          <ScrollReveal>
            ...
            >
              ...
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-5">
                ...
                <span className="text-gradient">scalable e-commerce platforms?</span>
              </h2>
